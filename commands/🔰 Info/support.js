...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    let button_public_invite = new MessageButton().setStyle('LINK').setLabel('Invite Bot').setURL("https://discord.com/oauth2/authorize?client_id=1051460029259190292&permissions=8&scope=bot%20applications.commands")
    ...
    message.reply({
      embeds: [new MessageEmbed()
        ...
        .setFooter('Bleep Bloop | powered by psycho006develop', 'https://i.imgur.com/fUFZPwj.png')
        .setURL("https://discord.com/oauth2/authorize?client_id=1051460029259190292&permissions=8&scope=bot%20applications.commandss")
      ],
